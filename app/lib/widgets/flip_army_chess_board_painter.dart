...
class FlipArmyChessBoardPainter extends CustomPainter {
  final int? selectedRow;
  final int? selectedCol;

  FlipArmyChessBoardPainter({this.selectedRow, this.selectedCol});
  ...
  @override
  bool shouldRepaint(FlipArmyChessBoardPainter oldDelegate) {
