...
import 'othello_game_page.dart';

class OthelloHomePage extends StatefulWidget {
  const OthelloHomePage({super.key});
...
class _OthelloHomePageState extends State<OthelloHomePage> {
  ...
  void _createRoom() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => OthelloGamePage(roomId: null),
      ),
    ).then((_) {
      if (mounted) {
  ...
  void _joinRoom() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => OthelloGamePage(roomId: _controller.text.trim()),
      ),
    ).then((_) {
      if (mounted) {
